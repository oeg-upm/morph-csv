...
from model.RMLTriplesMap import build_example_triples_map
...
cut_command_generator = CutCommandsGenerator("tmp/studentsport/example1-mapping-csv.ttl", student_csv)
