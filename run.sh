...
#GTFS
python3 morphcsv.py  -c evaluation/gtfs/config-gtfs.json -q evaluation/gtfs/query9.rq
...
#BIO2RDF:
#python3 morphcsv.py  -c evaluation/bio2rdf/config.json -q evaluation/bio2rdf/queries/query1.rq
